...
OUT_DIR   = flownetsrc/ops/build
PREPROCESSING_SRC = "flownetsrc/ops/preprocessing/preprocessing.cc" "flownetsrc/ops/preprocessing/kernels/flow_augmentation.cc" "flownetsrc/ops/preprocessing/kernels/augmentation_base.cc" "flownetsrc/ops/preprocessing/kernels/data_augmentation.cc"
GPU_SRC_DATA_AUG  	= flownetsrc/ops/preprocessing/kernels/data_augmentation.cu.cc
GPU_SRC_FLOW     	= flownetsrc/ops/preprocessing/kernels/flow_augmentation_gpu.cu.cc
...
DOWNSAMPLE_SRC = "flownetsrc/ops/downsample/downsample_kernel.cc" "flownetsrc/ops/downsample/downsample_op.cc"
GPU_SRC_DOWNSAMPLE  = flownetsrc/ops/downsample/downsample_kernel_gpu.cu.cc
GPU_PROD_DOWNSAMPLE = $(OUT_DIR)/downsample_kernel_gpu.o
DOWNSAMPLE_PROD 	= $(OUT_DIR)/downsample.so

CORRELATION_SRC = "flownetsrc/ops/correlation/correlation_kernel.cc" "flownetsrc/ops/correlation/correlation_grad_kernel.cc" "flownetsrc/ops/correlation/correlation_op.cc"
GPU_SRC_CORRELATION  = flownetsrc/ops/correlation/correlation_kernel.cu.cc
GPU_SRC_CORRELATION_GRAD  = flownetsrc/ops/correlation/correlation_grad_kernel.cu.cc
GPU_SRC_PAD = flownetsrc/ops/correlation/pad.cu.cc
...
FLOWWARP_SRC = "flownetsrc/ops/flow_warp/flow_warp_op.cc" "flownetsrc/ops/flow_warp/flow_warp.cc" "flownetsrc/ops/flow_warp/flow_warp_grad.cc"
GPU_SRC_FLOWWARP = "flownetsrc/ops/flow_warp/flow_warp.cu.cc"
GPU_SRC_FLOWWARP_GRAD = "flownetsrc/ops/flow_warp/flow_warp_grad.cu.cc"
